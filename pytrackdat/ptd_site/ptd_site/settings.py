...
ENV_GDAL = os.environ.get("GDAL_LIBRARY_PATH", "")
if ENV_GDAL:
    GDAL_LIBRARY_PATH = ENV_GDAL
    
ENV_SPATIALITE = os.environ.get("SPATIALITE_LIBRARY_PATH", "")
if ENV_SPATIALITE:
    SPATIALITE_LIBRARY_PATH = ENV_SPATIALITE
