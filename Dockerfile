...
RUN ln -s /usr/local/lib/python3.8/dist-packages/pytrackdat/ptd_site/databases /home/ptd_user/databases \
...
CMD [ "gunicorn", "-u", "ptd_user", "-b", ":8000", "-w", "2", "pytrackdat.ptd_site.ptd_site.wsgi:application" ]
